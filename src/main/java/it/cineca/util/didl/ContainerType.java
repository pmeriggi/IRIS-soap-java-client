 ...
 *   &lt;complexContent>
 *     &lt;extension base="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}ContainerType">
 *       &lt;sequence>
 *         &lt;element ref="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}Descriptor" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}Container" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}Item" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ContainerType", propOrder = { "descriptor", "container", "item" })
public class ContainerType extends it.cineca.util.didmodel.ContainerType {
	...
	protected List<JAXBElement<? extends it.cineca.util.didmodel.ContainerType>> container;

	/** The item. */
	@XmlElementRef(name = "Item", namespace = "urn:mpeg:mpeg21:2002:02-DIDMODEL-NS", type = JAXBElement.class)
	protected List<JAXBElement<? extends it.cineca.util.didmodel.ItemType>> item;
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the container property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link it.cineca.util.didmodel.ContainerType }
	 * 
	 * @return the container {@code >} {@link JAXBElement }{@code <}{@link ContainerType }{@code >}
	 */
	public List<JAXBElement<? extends it.cineca.util.didmodel.ContainerType>> getContainer() {
		if (container == null) {
			container = new ArrayList<JAXBElement<? extends it.cineca.util.didmodel.ContainerType>>();
		}
		return container;
	}
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link it.cineca.util.didmodel.ItemType }{@code >}
	 * 
	 * @return the item {@link JAXBElement }{@code <}{@link it.cineca.util.didl.ItemType }{@code >}
	 */
	public List<JAXBElement<? extends it.cineca.util.didmodel.ItemType>> getItem() {
		if (item == null) {
			item = new ArrayList<JAXBElement<? extends it.cineca.util.didmodel.ItemType>>();
		}
		return item;
	}
