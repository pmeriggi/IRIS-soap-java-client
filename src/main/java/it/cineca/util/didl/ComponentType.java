 ...
 *   &lt;complexContent>
 *     &lt;extension base="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}ComponentType">
 *       &lt;sequence>
 ...
 *         &lt;element ref="{urn:mpeg:mpeg21:2002:02-DIDMODEL-NS}Resource" maxOccurs="unbounded"/>
...
@XmlType(name = "ComponentType", propOrder = { "condition", "descriptor", "resource", "anchor" })
public class ComponentType extends it.cineca.util.didmodel.ComponentType {
	...
	/** The resource. */
	@XmlElementRef(name = "Resource", namespace = "urn:mpeg:mpeg21:2002:02-DIDMODEL-NS", type = JAXBElement.class)
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the resource property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link it.cineca.util.didl.ResourceType }{@code >}
	 * 
	 * @return the resource {@link JAXBElement }{@code <}{@link it.cineca.util.didmodel.ResourceType }{@code >}
	 */
	public List<JAXBElement<?>> getResource() {
		if (resource == null) {
			resource = new ArrayList<JAXBElement<?>>();
		}
		return resource;
	}
