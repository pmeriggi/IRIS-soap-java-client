...
@XmlType(name = "oai_dcType", propOrder = { "titleOrCreatorOrSubject" })
public class OaiDcType {

	/** The title or creator or subject. */
	@XmlElementRefs({ @XmlElementRef(name = "language", namespace = "http://purl.org/dc/elements/1.1/", type = JAXBElement.class),
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the titleOrCreatorOrSubject property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link ElementType }{@code >} {@link JAXBElement }
	 * 
	 * @return the title or creator or subject {@code <}{@link ElementType }{@code >} {@link JAXBElement }{@code <}{@link ElementType }{@code >}
	 * {@link JAXBElement }{@code <} {@link ElementType }{@code >} {@link JAXBElement }{@code <}{@link ElementType }{@code >}
	 * {@link JAXBElement }{@code <}{@link ElementType } {@code >} {@link JAXBElement }{@code <}{@link ElementType }{@code >}
	 * {@link JAXBElement }{@code <}{@link ElementType }{@code >} {@link JAXBElement }{@code <}{@link ElementType }{@code >} {@link JAXBElement }
	 * {@code <}{@link ElementType }{@code >} {@link JAXBElement } {@code <}{@link ElementType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ElementType }{@code >} {@link JAXBElement }{@code <} {@link ElementType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ElementType }{@code >} {@link JAXBElement }{@code <}{@link ElementType } {@code >}
	 */
	public List<JAXBElement<ElementType>> getTitleOrCreatorOrSubject() {
		...
		return titleOrCreatorOrSubject;
	}
