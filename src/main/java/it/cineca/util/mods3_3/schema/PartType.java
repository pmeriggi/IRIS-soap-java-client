...
@XmlType(name = "partType", propOrder = { "detailOrExtentOrDate" })
public class PartType {

	/** The detail or extent or date. */
	@XmlElements({ @XmlElement(name = "extent", type = ExtentType.class), @XmlElement(name = "detail", type = DetailType.class),
			@XmlElement(name = "text", type = UnstructuredText.class), @XmlElement(name = "date", type = BaseDateType.class) })
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the detailOrExtentOrDate property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ExtentType } {@link DetailType } {@link UnstructuredText }
	 * 
	 * @return the detail or extent or date {@link BaseDateType }
	 */
	public List<Object> getDetailOrExtentOrDate() {
		if (detailOrExtentOrDate == null) {
			detailOrExtentOrDate = new ArrayList<Object>();
		}
		return detailOrExtentOrDate;
	}
