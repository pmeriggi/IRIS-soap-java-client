...
/**
 * <p>
 * Java class for holdingSimpleType complex type.
 * <p>
...
@XmlType(name = "holdingSimpleType", propOrder = { "copyInformation" })
public class HoldingSimpleType {
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the copyInformation property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link CopyInformationType }
	 * 
