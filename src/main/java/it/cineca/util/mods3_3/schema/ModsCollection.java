...
@XmlRootElement(namespace = "http://www.loc.gov/mods/v3", name = "modsCollection")
public class ModsCollection {
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the mods property.
	 * <p>
