...
@XmlType(name = "originInfoType", propOrder = { "placeOrPublisherOrDateIssued" })
public class OriginInfoType {

	/** The place or publisher or date issued. */
	@XmlElementRefs({ @XmlElementRef(name = "issuance", namespace = "http://www.loc.gov/mods/v3", type = JAXBElement.class),
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the placeOrPublisherOrDateIssued
	 * property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link DateType }{@code >} {@link JAXBElement }
	 * 
	 * @return the place or publisher or date issued {@code <}{@link String }{@code >} {@link JAXBElement }{@code <}{@link String }{@code >}
	 * {@link JAXBElement }{@code <}{@link String } {@code >} {@link JAXBElement }{@code <}{@link DateType }{@code >} {@link JAXBElement }
	 * {@code <}{@link PlaceType }{@code >} {@link JAXBElement }{@code <}{@link DateType }{@code >} {@link JAXBElement }{@code <}
	 * {@link DateType }{@code >} {@link JAXBElement } {@code <}{@link DateOtherType }{@code >} {@link JAXBElement }{@code <}
	 * {@link StringPlusAuthority }{@code >} {@link JAXBElement }{@code <} {@link DateType }{@code >} {@link JAXBElement }{@code <}
	 * {@link DateType }{@code >}
	 */
	public List<JAXBElement<?>> getPlaceOrPublisherOrDateIssued() {
		...
		return placeOrPublisherOrDateIssued;
	}
