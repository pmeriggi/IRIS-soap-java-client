...
/**
 * <p>
 * Java class for copyInformationType complex type.
 * <p>
...
@XmlType(name = "copyInformationType", propOrder = { "form", "subLocation", "shelfLocator", "electronicLocator", "note",
...
public class CopyInformationType {
	 ...
	 * 
	 * @param value allowed object is {@link StringPlusAuthority }
	 */
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the subLocation property.
	 * <p>
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the shelfLocator property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the electronicLocator property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the note property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link StringPlusDisplayLabelPlusType }
	 * 
	 * @return the note
	 */
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the enumerationAndChronology property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link EnumerationAndChronologyType }
	 * 
