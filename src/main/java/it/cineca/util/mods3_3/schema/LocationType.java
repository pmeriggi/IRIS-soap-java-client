...
@XmlType(name = "locationType", propOrder = { "physicalLocation", "shelfLocator", "url", "holdingSimple", "holdingExternal" })
public class LocationType {
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the physicalLocation property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link PhysicalLocationType }
	 * 
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the url property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param value allowed object is {@link HoldingSimpleType }
	 */
